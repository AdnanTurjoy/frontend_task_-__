      ...
      <div style={styles.container}>
        <div style={styles.header}>
		  ...
		  <Flex justify="space-between" align="center">
			...
			<Button  type="outline"><GoogleOutlined /> Sign In with Google</Button>
			<Button  type="outline"><AppleOutlined /> Sign In with Apple ID</Button>
        ...
        >
          ...
          >
            <Input prefix={<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
